...
public class ConsentManagerImplTest extends PowerMockTestCase {
    ...
    @Test
    public void testConsentManagementWhenCaseSensitiveUserNameDisabled() throws Exception {
        ...
        PowerMockito.doReturn(false).when(spyConsentManager, "isCaseSensitiveUserNameEnabled", any());
